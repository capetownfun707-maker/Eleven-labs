...
import { VoiceCreateDialog } from "@/app/(dashboard)/voices/components/voice-create-dialog";
...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:info@codenow101.com",
      icon: Headphones,
    },
  ];
    ...
    <>
      ...
      <Sidebar collapsible="icon">
        <SidebarHeader className="flex flex-col gap-4 pt-4">
          <div className="flex items-center gap-2 pl-1 group-data-[ccollapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
            <Image
              src={"/head.jpg"}
              alt="Logo"
              height={40}
                ...
                appearance={{
                  elements: {
                    ...
                    organizationSwitcherTrigger:
                      "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap3! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1!",
            ...
            <SidebarMenuItem>
              <UserButton
                ...
                appearance={{
                  elements: {
                    rootBox:
                      "w-full! group-data[collapsible=icon]:w-auto! group-data-[collapsible=icon]:flex! group-data-[colapsible=icon]:justify-center!",
                    userButtonTrigger:
