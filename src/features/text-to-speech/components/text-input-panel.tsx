  ...
  return (
    <div className="flex h-full min-h-0 flex-col flex-1">
      ...
      <div className="relative min-h-0 flex-1">
        ...
        {/* Bottom fade overlay */}
        <div className="pointer-event-none absolute inset-x-0 bottom-0 h-8 bg-linear-to-t from-background to-transparent" />
      </div>

      {/* Action Bar — now outside the relative/flex-1 container */}
