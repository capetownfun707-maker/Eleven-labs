...
function FileDropzone({
  ...
  if (file) {
    return (
      <div className="flex items-center gap-3 rouned-xl border p-4">
            ...
            return (
              <Field data-invalid>
                <div className="relative flex items-center">
                  <div className="pointer-events-non absolute left-0 flex h-full w-11 items-center justify-center">
